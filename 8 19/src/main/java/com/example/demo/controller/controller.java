...
public class controller {
    ...
    public ResponseEntity<Page<student>> get(@RequestParam("index")Integer index, @RequestParam("size")Integer size){
        return ResponseEntity.ok(service.findStudentWithPages(index,size));
        // http://localhost:8080/student?index=0&size=2
    }
}
