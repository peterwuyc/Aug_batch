...
public class ServiceImp implements Service {
    ...
    public student getOneStudent(Integer id) {
        return studentTable.findById(id).orElse(null);
    }

    @Override
    public Page<student> findStudentWithPages(Integer index, Integer size) {
        Sort.Order sort=new Sort.Order(Sort.Direction.ASC,"id");
        return studentTable.findStudentWithPages(PageRequest.of(index,size,Sort.by(sort)));
    }
}
